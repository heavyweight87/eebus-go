...
func (e *CDT) HandleEvent(payload spineapi.EventPayload) {
	...
	case *model.SetpointConstraintsListDataType:
		e.setpointConstraintsUpdate(payload)

	case *model.SetpointListDataType:
		e.setpointsUpdate(payload)
...
func (e *CDT) setpointsUpdate(payload spineapi.EventPayload) {
	e.EventCB(payload.Ski, payload.Device, payload.Entity, DataUpdatesetpoint)
}

func (e *CDT) setpointConstraintsUpdate(payload spineapi.EventPayload) {
...
func (e *CDT) connected(entity spineapi.EntityRemoteInterface) {
	// Request the operation mode descriptions and setpoint relationships
	// to resolve the mapping between operation modes and setpoints.
	// This is essential to determine the appropriate setpoint for each operation mode.
